...
class Mapper:
    ...
    __defaultSpecies    = 'hsa'
    __defaultAnnotation = 'ensembl'
    ...
    def __init__(self, configFile=None, species=None, parseAnnotation=True, verbose=False, log=sys.stderr):
        ...
        try:
            ...
            annotFiles = [ f for f in os.listdir(self.conf[self.species]['MetaDataStoragePath']) if re.search('^[^_]+_[^_]+_[^_]+\.gz$', f) ]
